---
name: x-read
description: "Deep-read an X (Twitter) post via Grok + Live Search - verbatim post, thread, TL;DR, claims, reply sentiment, voices to watch Triggers: read this x post, deep read this tweet, analyze this tweet, read this thread. Use only when the user explicitly asks for it."
metadata:
  category: research
---
