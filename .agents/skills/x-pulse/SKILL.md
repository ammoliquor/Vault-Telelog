---
name: x-pulse
description: "Scan X for what's trending in a topic - themes, voices, hooks, and post ideas powered by Grok + Live Search Triggers: x pulse, what is trending on twitter, scan x for, twitter pulse. Use only when the user explicitly asks for it."
metadata:
  category: research
---
